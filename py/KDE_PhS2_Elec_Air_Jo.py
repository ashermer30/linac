...
for i in range(file_num,file_num+1):
        ...
        newdfsub.to_root(f"/work/as17540/PhaseSpaces/Generated_PhS2_Electrons_10x10_{air_density}/Jo_generatedElectron_PhS2_10x10_{air_density}.root", key='PhaseSpace')
