...
filename=f"/work/as17540/PhaseSpaces/PhS2_10x10_p1_Elec_v2/output*GateMaterials_{air_density}.db.root"
...
for i in range(file_num,file_num+1):
        ...
        newdfsub.to_root(f"/work/as17540/PhaseSpaces/Generated_PhS2_Electrons_10x10_{air_density}/generatedElectron_PhS2_10x10_{air_density}_{i}.root", key='PhaseSpace')
